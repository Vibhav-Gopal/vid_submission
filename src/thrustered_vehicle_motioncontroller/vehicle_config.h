...
#define SURGE_VECTOR {0,0,0,1,-1,1,-1}
#define SWAY_VECTOR  {0,0,0,1,1,1,1}
#define HEAVE_VECTOR {1,1,1,0,0,0,0}

#define YAW_VECTOR   {0,0,0,1,-1,-1,1}
#define PITCH_VECTOR {1,-0.75,-0.75,0,0,0,0} 
#define ROLL_VECTOR  {0,-1,1,0,0,0,0}
